...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
! Public variables
  integer(i_kind),parameter,public:: ngrids_nst=19
  integer(i_kind),parameter,public:: nstio_lhead1=32
  integer(i_kind),parameter,public:: nstio_intkind=4,nstio_realkind=4,nstio_dblekind=8
  real(nstio_realkind),parameter,public:: nstio_realfill=-9999._nstio_realkind
  real(nstio_dblekind),parameter,public:: nstio_dblefill=-9999._nstio_dblekind
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
! Public types
...
!-------------------------------------------------------------------------------
  subroutine nstio_srdata(lu,head,data,iret)
    ...
    type(nstio_data),intent(inout):: data
    integer(nstio_intkind),intent(out):: iret
    integer(i_kind):: dim1,dim2,dim3,mdim1,mdim2,mdim3
    integer(i_kind):: ios
