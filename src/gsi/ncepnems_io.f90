...
!                       write sequence.  Also, allocate and deallocate
...
200    format('sfcf',i2.2)
       ...
       fhour = real(nfhour,r_single) + real(nfminute,r_single)/r60 + real(nfsecondn,r_single)/real(nfsecondd,r_single)/r3600
       odate(1) = idate(4)  !hour
       odate(2) = idate(2)  !month
       odate(3) = idate(3)  !day
       odate(4) = idate(1)  !year
...
!   Declare local variables
    character(len=24)  :: filename
    character(len=120) :: my_name = 'read_sfc_anl'
    character(len=1)   :: null = ' '
    integer(i_kind) :: i,j
    integer(i_kind) :: iret, nframe, lonb, latb
    integer(i_kind) :: nfhour, nfminute, nfsecondn, nfsecondd
...
!   Declare local variables
    ...
    character(len=120) :: my_name = 'read_nst'
    character(len=1)   :: null = ' '
...
!
!      Get diurnal warming amount at z=0
!
       do j = 1,nlon_sfc
          do i = 1,nlat_sfc
             if (z_w(i,j,it) > zero) then
